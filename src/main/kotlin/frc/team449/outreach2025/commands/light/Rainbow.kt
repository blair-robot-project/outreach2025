package frc.team449.outreach2025.commands.light

import edu.wpi.first.math.MathUtil
import edu.wpi.first.wpilibj2.command.Command
import frc.team449.outreach2025.subsystems.light.Light
import frc.team449.outreach2025.subsystems.light.LightConstants
...
class Rainbow(
    ...
    override fun execute() {
        for (i in LightConstants.SECTION_1_START..LightConstants.SECTION_1_END) {
            val hue =
                MathUtil.inputModulus(firstHue + i * 180 / (LightConstants.SECTION_1_END - LightConstants.SECTION_1_START), 0.0, 180.0)
        ...
        for (i in LightConstants.SECTION_2_START..LightConstants.SECTION_2_END) {
            val hue =
                MathUtil
                    .inputModulus(
                        firstHue +
                            (i - LightConstants.SECTION_2_START) * 180 / (LightConstants.SECTION_2_END - LightConstants.SECTION_2_START),
                        0.0,
                        180.0
                    )
